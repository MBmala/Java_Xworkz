...
import com.xworkz.marker_interface.clone.CustomCloneable;

public class PhoneBookDTO implements CustomCloneable{
//public class PhoneBookDTO implements Cloneable- for direct
	private String name;
	...
	protected Object clone() throws CloneNotSupportedException {
		...
		return super.clone();
		//bcz of protected it is not visible outside the class
	}*/
